...
const FeedbackPage: React.FC = () => {
  ...
  const loadFeedback = () => {
    ...
    if (isStudent && currentUser) {
      ...
      // Moderators don't see any feedback
      setFeedback([]);
    }
  };
  ...
  const handleSubmitFeedback = () => {
    ...
    if (containsBadWords(content)) {
      showToastMessage('Your feedback contains inappropriate language. Please revise it.', 'error');
      return;
    }
    ...
    showToastMessage('Thank you for your feedback! It will be reviewed.', 'success');
  };
  ...
  // If not admin or student, show access denied
            ...
            <Card key={item.id}>
              <CardContent className="p-6">
                ...
                <p className="text-gray-700 dark:text-gray-300">
                  {item.status === 'rejected' ? '[This feedback was removed due to inappropriate content]' : item.content}
                </p>
                
                {/* Only show "Anonymous Student" for admin view */}
                {isAdmin && (
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <p className="mt-1 text-xs text-gray-500">
              Your feedback will be anonymous to administrators. Inappropriate language will result in rejection.
            </p>
          </div>
        </div>
