...
const ChatBot: React.FC = () => {
  ...
  const OPENROUTER_API_KEY = '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';
    ...
    try {
      ...
      const response = await fetch(OPENROUTER_API_URL, {
        ...
        headers: {
          ...
          'X-Title': 'College Communication Platform' // Optional but recommended
        },
        body: JSON.stringify({
